...
def get_deposit_products():
    ...
    for x in optionList:
        ...
        new_option = dict()
        new_option["저축 금리"]= x["intr_rate"]
        new_option["저축 기간"]= x["save_trm"]
        new_option["저축금리유형"]= x["intr_rate_type"]
        new_option["저축금리유형명"]= x["intr_rate_type_nm"]
        new_option["최고 우대 금리"]= x["intr_rate2"]
